              ...
              <Card className="h-full hover:border-[var(--color-brand-primary)] hover:shadow-lg transition-all">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    <div className="size-12 rounded-lg bg-[var(--color-brand-primary)]/10 flex items-center justify-center text-[var(--color-brand-primary)] shrink-0">
                      {ICON_MAP[category.icon] || <HelpCircle className="size-6" />}
                    </div>
                    <div className="flex-1">
                      <h3 className="font-semibold text-foreground group-hover:text-[var(--color-brand-primary)] transition-colors flex items-center gap-2">
                        {category.name}
