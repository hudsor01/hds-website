...
const TEMPLATES: {
...
}[] = [
	{
		...
		description:
			'General agreement for professional services with payment terms and deliverables'
	},
	{
		value: 'nda',
	...
	},
	{
		...
		description:
			'Independent contractor agreement with scope, payment, and ownership terms'
	}
]
