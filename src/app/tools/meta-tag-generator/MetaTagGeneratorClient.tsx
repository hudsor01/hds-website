...
<meta name="description" content="${inputs.pageDescription}" />${
		inputs.keywords
			? `
...
<meta property="og:description" content="${inputs.pageDescription}" />${
		inputs.imageUrl
			? `
...
<meta property="twitter:description" content="${inputs.pageDescription}" />${
		inputs.imageUrl
			? `
<meta property="twitter:image" content="${inputs.imageUrl}" />`
			: ''
	}${
		inputs.twitterHandle
			? `
