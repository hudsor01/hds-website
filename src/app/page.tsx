    ...
    <main className="min-h-screen bg-gradient-hero">
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-8">
              <div>
                <h1 className="text-responsive-lg font-black text-white leading-[1.1] mb-6 text-balance">
                  ...
                  <span className="block gradient-text bg-clip-text text-cyan-400">
              ...
              <div className="typography max-w-2xl">
            ...
            <div className="lg:col-span-5">
              <div className="relative">
                ...
                <div className="absolute inset-0 bg-gradient-hero-20 rounded-3xl blur-3xl -z-10" />
                <div className="absolute top-4 right-4 w-32 h-32 bg-gradient-primary-30 rounded-full blur-2xl -z-10" />

                {/* Terminal Window */}
                <div className="relative glass-card-light overflow-hidden rounded-xl">
                  {/* Terminal Header */}
                  <div className="bg-card/80 border-b border-border px-4 py-3 flex items-center justify-between">
                  ...
                  <div className="p-6 font-mono text-sm space-y-2" role="log">
                    ...
                    <div className="text-green-40">[OK] Deployment successful</div>
                    ...
                    <div className="pt-2 space-y-1">
                      ...
                      <div className="text-cyan-30">SEO: 98/100</div>
                    </div>
        ...
        <div className="container-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {solutions.map((solution, index) => (
              <div
                key={index}
                className="group relative glass-card-light p-8 card-hover-glow transition-smooth hover:scale-105"
              >
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    <div className="p-3 rounded-xl bg-gradient-hero-20 border border-cyan-500/30 group-hover:scale-110 transition-transform duration-300">
                      <solution.icon className="h-6 w-6 text-cyan-40" />
                    </div>
                  ...
                  <div className="space-y-3">
                    {solution.features.map((feature, featureIndex) => (
                      <div key={featureIndex} className="flex items-center gap-3">
                        <div className="w-2 h-2 rounded-full bg-gradient-secondary flex-shrink-0" />
        ...
        <div className="container-wide relative">
          <div className="text-center mb-20 typography">
            <h2 className="text-responsive-md font-black text-white mb-6">
              <span className="gradient-text relative">
                Proven Impact
                <span className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-20 h-1 bg-gradient-to-r from-cyan-40 to-blue-400 rounded-full"></span>
              </span>
            </h2>

            <div className="typography max-w-2xl mx-auto">
              <p className="text-xl text-gray-300 leading-relaxed">
                Numbers don&apos;t lie - our clients see <span className="text-cyan-40 font-semibold">measurable results</span> that transform their businesses
              </p>
            </div>
          </div>
            ...
            {results.map((result, index) => (
              ...
              >
                ...
                <div className="relative glass-card-light p-8 lg:p-10 card-hover-glow border border-cyan-400/20 hover:border-cyan-400/40 transition-all duration-500 group-hover:transform group-hover:scale-105">
                  {/* Top accent line */}
                  <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-16 h-1 bg-gradient-to-r from-cyan-40 to-blue-400 rounded-b-full"></div>

                  {/* Metric with enhanced styling */}
                  <div className="relative mb-4">
                    <div className="text-4xl lg:text-5xl font-black text-white mb-2 group-hover:text-cyan-40 transition-all duration-300 font-mono">
                      {result.metric}
                    </div>
                    <div className="absolute -inset-4 bg-gradient-to-r from-cyan-400/10 to-blue-40/10 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10"></div>
                  </div>

                  {/* Label with enhanced typography */}
                  <div className="text-lg font-bold text-gray-20 mb-3 group-hover:text-white transition-colors duration-300">
                    {result.label}
                  </div>
                ...
                {index < results.length - 1 && (
                  <div className="hidden lg:block absolute top-1/2 -right-5 transform -translate-y-1/2">
                    <div className="w-3 h-0.5 bg-gradient-to-r from-cyan-40/50 to-transparent"></div>
                  </div>
                )}
              </div>
            ))}
          ...
          <div className="text-center mt-16 pt-8 border-t border-gray-700/30">
            <p className="text-gray-40 text-sm font-medium">
              Join <span className="text-cyan-40 font-semibold">50+ successful businesses</span> who transformed with Hudson Digital Solutions
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="container-wide text-center">
          <div className="glass-section p-8 sm:p-12 md:p-16 max-w-4xl mx-auto">
            <Rocket className="w-16 h-16 text-cyan-40 mx-auto mb-8" />
            ...
            <div className="typography max-w-2xl mx-auto mb-10">
