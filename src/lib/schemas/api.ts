...
export const leadAttributionRequestSchema = z
	.object({
	...
	.refine(data => Boolean(data.email || data.session_id), {
		message: 'Either email or session_id is required',
		path: ['email']
	})

export type LeadAttributionRequest = z.infer<
	typeof leadAttributionRequestSchema
>
