...
export interface FormattedValidationError {
  ...
  /** Human-readable first error message */
  firstError: string;
}

/**
 * Format a Zod error into a consistent structure for API responses
 */
export function formatValidationError(error: z.ZodError): FormattedValidationError {
...
/**
 * Create a standardized validation error response object
 */
