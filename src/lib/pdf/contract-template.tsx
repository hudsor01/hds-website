...
const ServiceAgreementContent = ({ data }: { data: ContractData }) => (
	<>
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				{data.scopeOfWork || '[Scope of work to be defined]'}
			</Text>
		</View>
		...
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				In consideration for the Services, the Client agrees to pay the Service
				Provider:
			</Text>
			<Text style={styles.paragraph}>
		...
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				{data.timeline ||
					'The timeline for deliverables will be mutually agreed upon by both parties.'}
			</Text>
		</View>
		...
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				...
				shall transfer to the Client, except for any pre-existing materials
		...
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				...
				disclosed during the course of this agreement and not to disclose such
		...
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				...
				In case of termination, the Client shall pay for all work completed up
		...
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				The Service Provider&apos;s liability shall be limited to the total fees
				paid by the Client under this agreement. Neither party shall be liable
	...
	<>
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				...
				or written, disclosed by either party that is designated as confidential
		...
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>The Receiving Party agrees to:</Text>
			...
			<Text style={styles.bulletPoint}>
				- Use the Confidential Information only for the purposes of{' '}
				{data.scopeOfWork || 'the business relationship'}
			</Text>
			<Text style={styles.bulletPoint}>
				- Protect the Confidential Information with the same degree of care used
		...
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				...
				was in the Receiving Party&apos;s possession before disclosure; (c) is
		...
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				...
				{formatDate(data.effectiveDate)} until{' '}
				{data.endDate
					? formatDate(data.endDate)
					: 'terminated by either party with 30 days written notice'}
				. The confidentiality obligations shall survive for a period of 3 years
				after termination.
			</Text>
		</View>
		...
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				Upon termination or request, the Receiving Party shall promptly return
				or destroy all Confidential Information and certify such destruction in
				writing.
			</Text>
		</View>
		...
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				...
				irreparable harm and that monetary damages may be inadequate. Therefore,
				the Disclosing Party shall be entitled to seek equitable relief,
				including injunction and specific performance, in addition to other
				available remedies.
			</Text>
		</View>
	</>
...
const FreelanceContractContent = ({ data }: { data: ContractData }) => (
	<>
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				The Client hereby engages the Contractor as an independent contractor,
				and the Contractor accepts such engagement, to perform the following
				services:
			</Text>
			<Text style={styles.paragraph}>
				{data.scopeOfWork || '[Scope of work to be defined]'}
		...
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				{data.timeline ||
					'The Contractor shall complete the work within a mutually agreed timeline.'}
			</Text>
		</View>
		...
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				...
				Client. The Contractor is responsible for their own taxes, insurance,
				and benefits. The Contractor has the right to control the manner and
		...
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				Upon full payment, all work product created under this agreement shall
				be the property of the Client. The Contractor assigns all rights, title,
				and interest in the work product to the Client.
			</Text>
		</View>
		...
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				...
				the Client in connection with this project and will not disclose such
		...
		<View style={styles.section}>
			...
			<Text style={styles.paragraph}>
				The fee includes up to two (2) rounds of revisions. Additional revisions
				will be billed at an agreed hourly rate.
			</Text>
		</View>
	</>
)
			...
			<Page size="A4" style={styles.page}>
				...
				<View style={styles.header}>
					...
					<Text style={styles.subtitle}>
						Between {data.providerName || '[Provider]'} and{' '}
						{data.clientName || data.clientCompany || '[Client]'}
					</Text>
				</View>
				...
				<View style={styles.section}>
					...
					<Text style={styles.paragraph}>
						...
						the laws of the State of {data.providerState || 'Texas'}, without
