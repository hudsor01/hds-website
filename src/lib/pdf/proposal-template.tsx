		...
		<Document>
			...
			<Page size="A4" style={styles.page}>
				<View style={styles.coverPage}>
					...
					<Text style={styles.coverDate}>{formatDate(data.projectDate)}</Text>
				</View>
			...
			<Page size="A4" style={styles.page}>
				...
				<View style={styles.section}>
					...
					<Text style={styles.paragraph}>
						{data.overview || 'Project overview to be defined.'}
					</Text>
				</View>
					...
					<View style={styles.section}>
						...
						<View style={styles.pricingTable}>
							<View style={styles.pricingHeader}>
								<Text style={[styles.pricingHeaderText, styles.pricingItem]}>
									Description
								</Text>
								<Text style={[styles.pricingHeaderText, styles.pricingPrice]}>
									Amount
								</Text>
							</View>
							{data.pricingItems
								...
								.map((item, index) => (
									<View
										...
										style={[
											styles.pricingRow,
											index % 2 === 1 ? styles.pricingRowAlt : {}
										]}
									>
						...
						{data.paymentTerms && (
							<Text
								style={[
									styles.paragraph,
									{ marginTop: 15, fontSize: 9, color: '#666666' }
								]}
							>
			...
			<Page size="A4" style={styles.page}>
				...
				<View style={styles.aboutSection}>
					...
					<Text
						style={[
							styles.paragraph,
							{ marginTop: 10, fontSize: 9, color: '#666666' }
						]}
					>
						{data.companyAddress}
						{'\n'}
