...
export const AnnualWageSummary: React.FC<AnnualWageSummaryProps> = ({
	...
	const ssWageBase =
		getCurrentTaxData()?.ssWageBase ?? employeeData.totals.grossPay
	...
	return (
		<div
			...
			aria-label="Annual wage summary"
			role="article"
			className="annual-wage-summary"
		>
			{/* Save as PDF Button */}
			<div
				className="no-print"
			...
			>
					...
					>
						<div>
							<div style={{ marginBottom: '8px' }}>
								...
								<span style={{ fontSize: '12px', fontWeight: '600' }}>
									{employeeData.employeeName.toUpperCase()}
								</span>
							</div>
						...
						<div>
							...
							<div style={{ marginBottom: '8px' }}>
								...
								<br />
								<span style={{ fontSize: '12px' }}>
									{employeeData.filingStatus === 'single'
										? 'Single'
										: employeeData.filingStatus === 'marriedJoint'
											? 'Married filing jointly'
											: employeeData.filingStatus === 'marriedSeparate'
												? 'Married filing separately'
												: employeeData.filingStatus === 'headOfHousehold'
													? 'Head of household'
						...
						>
							...
							<div style={{ fontSize: '10px' }}>
								...
								>
									...
									<span>
										{formatCurrency(
											employeeData.totals.federalTax +
												employeeData.totals.socialSecurity +
												employeeData.totals.medicare
										)}
									</span>
								</div>
							</div>
				...
				>
					...
					>
						...
						>
							<strong>Box 1 - Wages, tips, other compensation:</strong>
							<br />
							{formatCurrency(employeeData.totals.grossPay)}
						</div>
						...
						>
							<strong>Box 2 - Federal income tax withheld:</strong>
							<br />
							{formatCurrency(employeeData.totals.federalTax)}
						</div>
						...
						>
							<strong>Box 3 - Social security wages:</strong>
							<br />
						...
						>
							<strong>Box 4 - Social security tax withheld:</strong>
							<br />
							{formatCurrency(employeeData.totals.socialSecurity)}
						</div>
						...
						>
							<strong>Box 5 - Medicare wages and tips:</strong>
							<br />
							{formatCurrency(employeeData.totals.grossPay)}
						</div>
						...
						>
							<strong>Box 6 - Medicare tax withheld:</strong>
							<br />
							{formatCurrency(employeeData.totals.medicare)}
						</div>
					</div>
				...
				>
					...
					>
						<div>
							<strong>EMPLOYER CERTIFICATION:</strong>
							<br />
							This document certifies that the above information accurately
							reflects all compensation paid and taxes withheld for the employee
							during the specified tax year in compliance with federal tax
							regulations.
						</div>
						<div>
							<strong>EMPLOYEE NOTICE:</strong>
							<br />
							Retain this document for tax filing purposes. This statement
							contains information required for completing your federal income
							tax return and should be kept with your permanent tax records.
						</div>
					</div>
					<div
						style={{
					...
					>
						<div>
							...
							| <strong>Reference:</strong> AWS-{employeeData.taxYear}-
							{generateReferenceId()}
						</div>
