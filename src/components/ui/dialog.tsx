      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="dialog-close-button data-[state=open]:bg-accent data-[state=open]:text-muted-foreground opacity-70 transition-opacity hover:opacity-100 disabled:pointer-events-none"
          >
