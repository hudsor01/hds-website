        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          >
            <a 
              ...
              className="p-1.5 bg-white/10 rounded border border-cyan-500/30 text-gray-400 hover:text-secondary-400 hover:bg-white/20 transition-all duration-300 group focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-black"
              aria-label="Follow Hudson Digital on LinkedIn"
            >
              <span className="sr-only">LinkedIn - hudsor01</span>
              <svg className="h-3 w-3 group-hover:scale-110 transition-transform duration-200" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
